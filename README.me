...
![Pagina de Evolução e Performance](C:\Users\fabin\Desktop\projeto_streamlit\imagens\tela_evol_perfo.jpg)
...
![Pagina de Variação Mensal](C:\Users\fabin\Desktop\projeto_streamlit\imagens\tela_var_mensal.jpg)
...
* Filtro por tipo de variação (apenas altas, baixas ou meses estáveis).

* Interface Amigável: Construído com componentes Streamlit para uma experiência de usuário limpa e intuitiva.

* Dados em Tempo Real: Os dados das ações são baixados diretamente do Yahoo Finance usando a biblioteca yfinance.

## 🚀 Estrutura de Arquivos e Código

Para este projeto, foi usado app.py central para controlar a navegação.
...
├── IBOV.csv               (Base CSV que puxa o nome das ações)
└── README.md
